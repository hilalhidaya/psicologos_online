        ...
        <tbody>
          <?php while ($row = $resultado->fetch_assoc()): ?>
            <tr>
              ...
              <td>
                <a href="usuarios_admin.php?editar=<?= $row["idUser"] ?>" class="btn2">Editar</a>
                <a href="usuarios_admin.php?eliminar=<?= $row["idUser"] ?>" class="btn-danger" onclick="return confirm('¿Estás seguro de eliminar este usuario?')">Eliminar</a>
              </td>
            </tr>
          <?php endwhile; ?>
        </tbody>
